...
class CompanyAccount(BaseUserAccount):
    """
    Represents a company account in the system, inheriting from the base user class.
    ...
    def __init__(self, login_email: str, password: str, registered_name: str, mailing_address: str, public_email: str, website_url: str = None, phone_number: str = None) -> None:
        """
        Initializes a new 'CompanyAccount' instance.

        Args:
            login_email (str): The unqiue email  email used to log into the company's account.
